...
$obj2 = new player2();  
$obj3 = new player3();
echo "<table border = '1' style='border-collapse: collapse; text-align:center; margin-left:130px;'>";
echo "<tr style='margin-left:130px; text-align:center'><td>  Object  </td><td>  Name  </td><td>  Kit Number  </td> <td>  Position  </td></tr>";
echo "<tr style='margin-left:130px; text-align:center'><td>  player1</td><td>", $obj -> name(),"</td><td>", $obj -> number(), "</td><td>", $obj -> position(),"</td></tr>";
echo "<tr style='margin-left:130px; text-align:center'><td>  player2</td><td>", $obj2 -> name(),"</td><td>", $obj2 -> number(), "</td><td>", $obj2 -> position(),"</td></tr>";
echo "<tr style='margin-left:130px; text-align:center'><td>  player3</td><td>", $obj3 -> name(),"</td><td>", $obj3 -> number(), "</td><td>", $obj3 -> position(),"</td></tr>";
